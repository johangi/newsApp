...
async function categories(query){
    ...
    for(i = 0; i < result.length; i++){
        ...
        <div class="card m-3">
            ...
            <div class="card-body">
            <h5 class="card-title"><a href="${result[i].url}" style="text-decoration: none; color: #6A7A8Eff;" target="_blank">${result[i].title}</a></h5>
        ...
        <div class="card m-3">
            ...
            <div class="card-body">
            <h5 class="card-title"<a href="${result[i+1].url}" style="text-decoration: none; color: #6A7A8Eff;" target="_blank">${result[i+1].title}</a></h5>
        ...
        <div class="card m-3">
            ...
            <div class="card-body">
            <h5 class="card-title"><a href="${result[i+2].url}" style="text-decoration: none; color: #6A7A8Eff;" target="_blank">${result[i+2].title}</a></h5>
